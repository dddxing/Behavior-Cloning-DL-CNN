...
if __name__ == '__main__':
    ...
    print(f"Grade for part 1: {score_pos:.2f} / {part1_bound:.2f} * 4 = {grade1:.2f}, took {time.strftime('%H:%M:%S', time.gmtime(part1_end-part1_start))}")
    print(f"Grade for part 2: {score_rgb1:.2f} / {part2_bound:.2f} * 5 = {grade2:.2f}, took {time.strftime('%H:%M:%S', time.gmtime(part2_end-part2_start))}")
    print(f"Grade for part 3: {score_rgb2:.2f} / {part3_bound:.2f} * 6 = {grade3:.2f}, took {time.strftime('%H:%M:%S', time.gmtime(part3_end-part3_start))}")
